...
function inferApiEndpoints(routePath, routeKind) {
  ...
  if (routePath === '/login') return ['POST /api/v1/auth/login', 'POST /api/v1/auth/refresh', 'GET /api/v1/auth/me']
  if (routePath === '/dashboard') return ['GET /api/v1/dashboard/my', 'GET /api/v1/auth/me', 'GET /api/v1/users/me/campus-summary', 'GET /api/v1/points/my/summary', 'GET /api/v1/notifications/my']
  ...
  if (routePath.startsWith('/mycampus/attendance')) return ['GET /api/v1/attendance/monthly', 'GET /api/v1/attendance/today', 'GET /api/v1/attendance/my']
  ...
  if (routePath.startsWith('/classroom/curriculum')) return ['GET /api/v1/courses/my/curriculum', 'GET /api/v1/courses/my', 'GET /api/v1/courses/{courseId}/weeks', 'GET /api/v1/courses/{courseId}/weeks/{weekId}/sessions', 'GET /api/v1/courses/{courseId}/sessions']
  ...
  if (routePath.startsWith('/classroom/my-replays')) return ['GET /api/v1/course-sessions/replays/my']
  if (routePath.startsWith('/classroom/all-replays')) return ['GET /api/v1/course-sessions/replays']
  ...
  if (routePath.startsWith('/mentoring/meetups/apply')) return ['GET /api/v1/surveys', 'GET /api/v1/surveys/my-participations', 'POST /api/v1/surveys/{surveyId}/submit']
