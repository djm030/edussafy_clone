...
function inferApiEndpoints(routePath, routeKind) {
  ...
  if (routePath.startsWith('/classroom/curriculum')) return ['GET /api/v1/courses/my', 'GET /api/v1/courses/{courseId}/weeks', 'GET /api/v1/courses/{courseId}/weeks/{weekId}/sessions', 'GET /api/v1/courses/{courseId}/sessions']
