...
CREATE TABLE files (
    ...
    file_role VARCHAR(50) NOT NULL DEFAULT 'ATTACHMENT' COMMENT 'ATTACHMENT, EDITOR_IMAGE, THUMBNAIL, PROFILE_IMAGE, VIDEO_THUMBNAIL',
    ...
    CONSTRAINT chk_files_file_role CHECK (file_role IN ('ATTACHMENT', 'EDITOR_IMAGE', 'THUMBNAIL', 'PROFILE_IMAGE', 'VIDEO_THUMBNAIL'))
...
CREATE TABLE user_stats (
    ...
    attendance_rate DOUBLE NULL COMMENT '출석률',
...
CREATE TABLE user_learning_progresses (
    ...
    progress_rate DOUBLE NOT NULL DEFAULT 0 COMMENT '학습 진행률',
...
CREATE TABLE surveys (
    ...
    is_required TINYINT(1) NOT NULL DEFAULT 0 COMMENT '필수 참여 여부',
    ...
    location VARCHAR(255) NULL COMMENT '장소 또는 접속 위치',
    selection_policy TEXT NULL COMMENT '신청자 선정 정책',
